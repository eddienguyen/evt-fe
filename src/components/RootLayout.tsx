...
import { useAnchorNavigation, useScrollTo } from "@/hooks/useScrollTo";
...
const RootLayout: React.FC = () => {
  ...
  const getNavLinkClasses = (path: string): string => {
    const baseClasses =
      "hover:text-accent-gold transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-gold focus-visible:ring-offset-2 rounded-sm px-2 py-1";
            ...
            <div className="mt-4 inline-block bg-base-dark/50 backdrop-blur-sm border border-text-light/20 rounded-lg p-4 text-left shadow-lg">
              <div className="font-mono text-xs space-y-1">
                <div className="flex items-center gap-2 mb-2 pb-2 border-b border-text-light/20">
                  ...
                  <span className="font-bold text-sm text-accent-gold">
