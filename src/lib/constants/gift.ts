...
export const GIFT_LABELS = {
  // Panel structure
  title: 'Gửi quà cưới',
  description: 'Cảm ơn tấm lòng của bạn! Bạn có thể gửi quà cưới qua chuyển khoản ngân hàng.',
...
export const GIFT_HELP_TEXT = {
  ...
  qrCode: 'Quét mã QR bằng ứng dụng ngân hàng của bạn để chuyển khoản nhanh chóng',
  manualEntry: 'Hoặc nhập thông tin tài khoản thủ công vào ứng dụng ngân hàng',
  reference: 'Nhớ ghi chú "Mừng cưới N & Q" để chúng tôi biết đây là quà từ bạn'
} as const
...
export const GIFT_MESSAGES = {
  ...
  qrError: {
    loadFailed: 'Không thể tải mã QR. Vui lòng sử dụng thông tin tài khoản bên dưới.',
