 ...
 *
 * @module pages/admin/AdminGuestCreate
 */
...
/**
 * Admin Guest Create Page Component
 *
 * Provides interface for creating guests with real-time preview
 * and form validation.
 */
const AdminGuestCreate: React.FC = () => {
...
export default AdminGuestCreate;
